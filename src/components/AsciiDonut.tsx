 ...
 * Renders the famous spinning ASCII donut dynamically using JavaScript.
 */
export default function AsciiDonut() {
  ...
  return (
    <pre 
      ref={preRef} 
      className="text-[0.6rem] leading-[0.6rem] font-mono whitespace-pre overflow-hidden text-indigo-500/20 dark:text-indigo-400/20"
